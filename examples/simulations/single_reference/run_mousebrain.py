...
def set_base_config():
    base_config = {
        ...
        "output_dir": "outputs/single_reference_mousebrain/SMODER",
        "model_save_dir": os.path.join("outputs/single_reference_mousebrain/SMODER",
                                       "trained_models"),
    }
    # 自动创建输出目录
...
def set_analysis_params():
    params = {
        ...
        "pca_n_components_rna": 64,          # RNA模态PCA降维目标维度
        ...
        "weight_consistency": 0.1,             # 一致性损失权重
...
def parse_args():
    ...
    parser.add_argument(
        "--sc-rna",
        default="path/to/mousebrain/sc_mousebrain_processed.h5ad",
        help="Path to the single-cell RNA reference .h5ad file.",
    )
    parser.add_argument(
        "--st-rna",
        default="outputs/single_reference_mousebrain/simulation_rna.h5ad",
        help="Path to the simulated spatial RNA .h5ad file.",
    )
    parser.add_argument(
        "--st-modality2",
        default="outputs/single_reference_mousebrain/simulation_atac.h5ad",
        help="Path to the simulated second-modality .h5ad file.",
    )
    parser.add_argument(
        "--output-dir",
        default="outputs/single_reference_mousebrain/SMODER",
