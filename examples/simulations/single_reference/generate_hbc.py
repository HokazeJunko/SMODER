...
# ====================== 全局配置 ======================
# 路径配置
RAW_DATA_PATH = "path/to/HBC/reference_data"
OUT_PATH = "outputs/single_reference_hbc"
...
CORE_WEIGHT = 1000  # 核心峰权重
WEAK_WEIGHT_MIN = 50  # 弱峰最小权重
WEAK_WEIGHT_MAX = 250  # 弱峰最大权重
...
CELL_TYPE_NUMBER = [2, 2, 4, 3, 2, 2, 2, 3]
