"""Run SMODER on a single-reference RNA+synthetic ATAC simulated dataset.

This script takes simulated spatial RNA and ATAC files generated by
multi_reference/generate_rna_atac.py and runs SMODER on them.
...
python examples/simulations/paired_bimodal/run_atac_rna.py
  --sc-rna outputs/single_reference_rna_atac/ref_RNA_f2ab.h5ad
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SMODER on a single-reference RNA+synthetic ATAC simulated dataset."
    )
    ...
    parser.add_argument(
        "--st-atac",
        required=True,
        help="Path to the simulated spatial ATAC/peak .h5ad file.",
    )
    parser.add_argument(
        "--output-dir",
        required=True,
    ...
    parser.add_argument(
        "--no-top-n-filter",
        action="store_true",
        help="Disable top-n marker gene filtering. By default, top-n filtering is enabled for this example.",
    )
    ...
    parser.add_argument("--weight-spatial", type=float, default=0.0)
...
def load_data(base_config: dict, params: dict):
    ...
    print("Loading simulated spatial RNA...")
    ...
    print("Loading simulated spatial ATAC/peak...")
...
def save_results(adata_result, model, params: dict, base_config: dict, dim_rna: int, dim_modal2: int) -> None:
    ...
    with open(log_path, "w", encoding="utf-8") as f:
        f.write("# SMODER paired RNA+ATAC simulation run log\n")
...
def main() -> None:
    ...
    print("Running SMODER on paired RNA+ATAC simulated data")
    ...
    print("SMODER paired RNA+ATAC simulation run finished successfully.")
