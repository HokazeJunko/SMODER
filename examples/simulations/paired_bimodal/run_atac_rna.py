"""Run SMODER on a paired RNA+ATAC simulated dataset.

This script takes simulated spatial RNA and ATAC files generated by
generate_atac_rna.py and runs SMODER on them.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SMODER on a paired RNA+ATAC simulated dataset."
    )
