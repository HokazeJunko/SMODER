...
```bash
python analysis_scripts/real_data/run_hbc.py \
...
```bash
python analysis_scripts/real_data/run_mousebrain_h3k27me3.py \
...
```bash
python analysis_scripts/real_data/run_mouse_embryo.py \
