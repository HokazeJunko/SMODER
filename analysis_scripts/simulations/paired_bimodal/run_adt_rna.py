"""Run SMODER on a paired RNA+ADT simulated dataset.

This script takes simulated spatial RNA and ADT files generated by
generate_adt_rna.py and runs SMODER on them.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SMODER on a paired RNA+ADT simulated dataset."
    )
