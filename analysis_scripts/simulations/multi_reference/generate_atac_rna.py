...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate a multi-reference RNA+ATAC simulated spatial dataset."
    )

    parser.add_argument(
        "--input-dir",
        required=True,
        help="Directory containing paired single-cell RNA and ATAC reference .h5ad files.",
    )
    parser.add_argument(
        "--rna-file",
...
def main() -> None:
    ...
    print("=" * 80)
    print("Multi-reference RNA+ATAC spatial simulation finished.")
