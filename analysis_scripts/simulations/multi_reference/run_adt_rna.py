"""Run SMODER on a multi-reference RNA+ADT simulated dataset.

This script takes simulated spatial RNA and ADT files generated by
multi_reference/generate_adt_rna.py and runs SMODER on them.
...
python analysis_scripts/simulations/paired_bimodal/run_adt_rna.py
  --sc-rna outputs/multi_reference_adt_rna/ref_RNA_f2ab.h5ad
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SMODER on a multi-reference RNA+ADT simulated dataset."
    )
    ...
    parser.add_argument(
        "--st-adt",
        required=True,
        help="Path to the simulated spatial ADT .h5ad file.",
    )
    parser.add_argument(
        "--output-dir",
        required=True,
    ...
    parser.add_argument("--top-n-filter", action="store_true")
...
def load_data(base_config: dict, params: dict):
    ...
    print("Loading simulated spatial ADT...")
...
def save_results(adata_result, model, params: dict, base_config: dict, dim_rna: int, dim_modal2: int) -> None:
    ...
    with open(log_path, "w", encoding="utf-8") as f:
        f.write("# SMODER paired RNA+ADT simulation run log\n")
...
def main() -> None:
    ...
    print("Running SMODER on paired RNA+ADT simulated data")
    ...
    print("SMODER paired RNA+ADT simulation run finished successfully.")
