"""Run SMODER on a multi-reference RNA+ATAC simulated dataset.

This script takes simulated spatial RNA and ATAC files generated by
multi_reference/generate_atac_rna.py and runs SMODER on them.
...
python analysis_scripts/simulations/paired_bimodal/run_atac_rna.py
  --sc-rna outputs/multi_reference_atac_rna/ref_RNA_f2ab.h5ad
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run SMODER on a multi-reference RNA+ATAC simulated dataset."
    )
